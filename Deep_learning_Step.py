...
model.compile(
    ...
    optimizer=tensorflow.keras.optimizers.Adam(lr=0.0008, epsilon=None, decay=0.002, amsgrad=False),
    #optimizer=tensorflow.keras.optimizers.Nadam(lr=0.0003, beta_1=0.9, beta_2=0.999),#(lr=0.0003, epsilon=None, decay=0., amsgrad=False),
    #optimizer=tensorflow.keras.optimizers.SGD(lr=0.003, momentum=0.3, nesterov=False),
...
model.save_weights(f'./TBP{s_date}_weight')
